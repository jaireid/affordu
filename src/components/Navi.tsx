...
import { rem, Navbar, Text, Button } from "@mantine/core";
import { IconListSearch, IconListCheck, IconLogout } from "@tabler/icons-react";
      ...
      {currentUser ? (
        ...
        >
          <Navbar.Section grow mt="md">
            <Text weight={500} size="lg" mb="xs" align="center">
          ...
          <Navbar.Section>
            <Button
              fullWidth
              leftIcon={<IconLogout size="1.2rem" stroke={1.5} />}
              onClick={signOut}
            >
              <Text>Logout</Text>
            </Button>
