...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <Text color="dimmed" fz="lg" ta="center">
        Search and compare the net prices of colleges, and discover affordable
        options that meet your academic and financial goals.
      </Text>
      <Button
        variant="outline"
        fz="lg"
